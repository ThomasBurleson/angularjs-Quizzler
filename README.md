...
*  Six (6) questions are initially provided; without answers to the actual questions. 
  * See the [Requirements PDF](https://github.com/Mindspace/Desk-Quizzler/blob/master/docs/Proveyourself.pdf?raw=true) for a sample *[Quiz Content](https://raw.github.com/Mindspace/Desk-Quizzler/master/docs/quiz_comps.jpg)*   
